...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train AT-D3QN (Pan et al. 2023) flipper policy inside FTR-Benchmark (Isaac Sim)")
    parser.add_argument("--config", type=str, required=True, help="Path to a D3QN config yaml (see FtrD3QNConfig)")
