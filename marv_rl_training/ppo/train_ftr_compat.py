...
Usage:
    python -m marv_rl_training.ppo.train_ftr_compat \
...
from marv_rl_training.heightmaps.ftr_terrain import FtrTerrainPatchGenerator
...
from marv_rl_training.observations.ftr_compat_obs import FtrCompatObservation
from flipper_training.rl_objectives.random_nav import RandomNavigationObjective
from marv_rl_training.rl_rewards.ftr_compat_reward import FtrCompatReward
